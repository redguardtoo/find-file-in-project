...
*Features:*
- Works perfectly on any OS with minimum setup. Only dependency is =BSD/GNU Find=
...
The output of backend execution is expected to be [[http://www.gnu.org/software/diffutils/manual/html_node/Unified-Format.html][Unified Diff Format]].
