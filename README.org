...
- Uses native API =completing-read= and supports [[https://www.gnu.org/software/emacs/manual/html_mono/ido.html][ido]]/[[https://github.com/emacs-helm/helm][helm]]/[[https://github.com/abo-abo/swiper][ivy]]/[[https://github.com/minad/consult][consult/]]/[[https://github.com/raxod502/selectrum][selectrum]] out of box.  You can insert =(ivy-mode 1)= into =~/.emacs= to enable ivy completion.
...
Since =v6.0.0=, =Emacs 25.1= is required.
