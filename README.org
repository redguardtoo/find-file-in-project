#+TITLE: Find-File-In-Project Readme
#+Options: num:nil
#+STARTUP: odd
...
This program provides a couple methods for quickly finding any file in a given project. It depends on =BSD/GNU Find=.
...
Features:
- Works perfectly at any OS with minimum setup. Only dependency is =Find=
