...
- Tested with 50,000+ files (Linux Kernel) with NO performance issue
* Install
Please install through [[http://melpa.org/#/find-file-in-project][melpa]].

[[https://github.com/abo-abo/swiper][Ivy-mode]] is the dependency which will be installed automatically if you use melpa.
* Setup
...
All variables like `ffip-project-file` may be overridden on a per-directory basis in your .dir-locals.el. See (info "(Emacs) Directory Variables") for details.
